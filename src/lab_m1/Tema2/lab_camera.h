    ...
    class Camera
    {
     public:
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            glm::vec4 new_forward = glm::rotate(glm::mat4(1), angle, right) * glm::vec4(forward, 0);
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            // vectors!
            glm::vec4 new_forward = glm::rotate(glm::mat4(1), angle, glm::vec3(0, 1, 0)) * glm::vec4(forward, 0);
            forward = glm::normalize(glm::vec3(new_forward));

            glm::vec4 new_right = glm::rotate(glm::mat4(1), angle, glm::vec3(0, 1, 0)) * glm::vec4(right, 0);
