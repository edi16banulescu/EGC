...
void Lab9::Init()
{
...

    {
        ...
        meshes[mesh->GetMeshID()] = mesh;
        mapTextures["quad"] = CreateRandomTexture(25, 25);
    }
...
void Lab9::Update(float deltaTimeSeconds)
{
    ...
    {
        glm::mat4 modelMatrix = glm::mat4(1);
		modelMatrix = glm::translate(modelMatrix, glm::vec3(5, 1.5f, -3));
		modelMatrix = glm::scale(modelMatrix, glm::vec3(0.1f));
		RenderSimpleMesh(meshes["quad"], shaders["LabShader"], modelMatrix, mapTextures["quad"], mapTextures["earth"]);
    }
}
