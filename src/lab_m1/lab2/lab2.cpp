...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(0, 0,  1), glm::vec3(0, 0.2f, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 0,  1), glm::vec3(0, 0.5f, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 1,  1), glm::vec3(0, 0.3f, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 1,  1), glm::vec3(0, 0.4f, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 0.1f, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 0.2f, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 1,  0), glm::vec3(0, 0.3f, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 1,  0), glm::vec3(0, 0.8f, 1), glm::vec3(0.2, 0.8, 0.6)),
    ...
    {
        vector<VertexFormat> vertices_teth
        {
            //VertexFormat(glm::vec3(-1, -1,  1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            // TODO(student): Complete the vertices data for the cube mesh
            ...
            VertexFormat(glm::vec3(0.5, 1, 0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0.5, 0.5,  1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
        };

        vector<unsigned int> indices_teth =
        {
            1, 2, 3,    // indices for first triangle
            1, 3, 4,    // indices for second triangle
            1, 4, 2,
            2, 4, 3,
        };

        // Actually create the mesh from the data
        CreateMesh("teth", vertices_teth, indices_teth);
    }
...

    {
        vector<VertexFormat> vertices_square
        {
            ...
            VertexFormat(glm::vec3(0, 1,  0), glm::vec3(1, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
        };
    ...
    {
        vector<VertexFormat> vertices_teth_bonus
        {
            VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0.255f, 0, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 0,  0), glm::vec3(0.255f, 0, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0.5, 1, 0), glm::vec3(0.255f, 0, 0), glm::vec3(0.2, 0.8, 0.6)),

            VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0, 0.100f, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0.5, 1, 0), glm::vec3(0, 0.100f, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0.5, 0.5, 1), glm::vec3(0, 0.100f, 1), glm::vec3(0.2, 0.8, 0.6)),

            VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0, 0, 0.255f), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0.5, 0.5, 1), glm::vec3(0, 0, 0.255f), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 0, 0.255f), glm::vec3(0.2, 0.8, 0.6)),

            VertexFormat(glm::vec3(1, 0,  0), glm::vec3(0.255f, 0.69f, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0.5, 0.5, 1), glm::vec3(0.255f, 0.69f, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0.5, 1, 0), glm::vec3(0.255f, 0.69f, 0), glm::vec3(0.2, 0.8, 0.6)),
        };

        vector<unsigned int> indices_teth_bonus =
        {
            0, 1, 2,    // indices for first triangle
        ...
        // Actually create the mesh from the data
        CreateMesh("teth_bonus", vertices_teth_bonus, indices_teth_bonus);
    }
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(1.0f, 1.0f, 1.0f), glm::vec3(0.5f));

    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["teth"], shaders["VertexColor"], glm::vec3(1.5f, 1.5f, 1.5f), glm::vec3(0.5f));

    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(2.0f, 2.0f, 2.0f), glm::vec3(0.5f));

    RenderMesh(meshes["teth_bonus"], shaders["VertexColor"], glm::vec3(0.5f, 0.5f, 0.5f), glm::vec3(0.5f));
