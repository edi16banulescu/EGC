...
//            projectionMatrix = glm::perspective(RADIANS(fov), window->props.aspectRatio, 0.0001f, 10000.f);
//		}
//
...
//			orthoDelta += deltaTime * cameraSpeed * 3;
//			projectionMatrix = glm::ortho(-3.f - orthoDelta, 3.f + orthoDelta, -3.f - orthoDelta, 3.f + orthoDelta, 0.0001f, 10000.f);
//		}
//
