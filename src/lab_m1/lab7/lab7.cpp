...
void Lab7::Update(float deltaTimeSeconds)
{
    ...
    // Render ground
    {
        ...
        RenderSimpleMesh(meshes["plane"], shaders["LabShader"], modelMatrix, glm::vec3(0.898f, 0.898f, 0));
    }
...
void Lab7::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, const glm::vec3 &color)
{
    ...
    glUniform3fv(loc_light_position, 1.f, glm::value_ptr(lightPosition));
    ...
    glUniform3fv(loc_eye_position, 1.f, glm::value_ptr(eyePosition));
    ...
    glUniform3fv(loc_object_color, 1.f, glm::value_ptr(color));
