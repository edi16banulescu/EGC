...
void Lab4::RenderScene() {
    ...
    modelMatrix3 *= transform3D::Translate(0.0f, 0.5f, -1.5f);
    modelMatrix3 *= transform3D::Translate(cos(angularStepBonus) * 2, 0, -sin(angularStepBonus) * 2);
    modelMatrix3 *= transform3D::RotateOX(angularStepOX);
    modelMatrix3 *= transform3D::RotateOY(angularStepOY);
    modelMatrix3 *= transform3D::RotateOZ(angularStepOZ);
