...
void Lab1::Init()
{
    ...
    // no matter how many times we want to draw this mesh.
    {
        ...
        meshes[teapot->GetMeshID()] = sphere;
    }
...
void Lab1::Update(float deltaTimeSeconds)
{
    ...
    glClearColor(colorRed, colorGreen, colorBlue, 1);
    ...
    RenderMesh(meshes["teapot"], glm::vec3(2, 0.9f, 0), glm::vec3(0.9f));

    RenderMesh(meshes[objectName], glm::vec3(posX, posY, posZ), glm::vec3(1.0f));
}
